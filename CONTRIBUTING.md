...
Report bugs at [https://github.com/boromir674/cicd-test/issues](https://github.com/boromir674/cicd-test/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/boromir674/cicd-test/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
CI/CD Test Repository could always use more documentation, whether as part of the official CI/CD Test Repository docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/boromir674/cicd-test/issues](https://github.com/boromir674/cicd-test/issues).
...
Here's how to set up `cicd-test` for local development.

1. Fork the `cicd-test` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:boromir674/cicd-test.git
```
...
CI/CD Test Repository is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/boromir674/cicd-test/milestones?direction=desc&sort=due_date&state=open)
