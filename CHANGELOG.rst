...
| This is the first ever release of the **cicd_test** Python Package.
| The package is open source and is part of the **CI/CD Test Repository** Project.
| The project is hosted in a public repository on github at https://github.com/boromir674/cicd-test
...
- **CI Pipeline** running on Github Actions at https://github.com/boromir674/cicd-test/actions
